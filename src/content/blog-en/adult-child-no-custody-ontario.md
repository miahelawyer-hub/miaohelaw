...
relatedReading:
  ...
  - slug: foreign-divorce-avoid-spousal-support-ontario
    line: After a foreign divorce, child support and spousal support still have to be separated.
  - href: /en/family-law/child-custody/
    title: Child custody
    line: Primary caregiver, parenting time, and urgent motions are built for minor children.
...
<ul>
<li>Short answer: once the child is an adult, there's usually nothing left to fight over.</li>
<li>What people call custody is for minor children.</li>
<li>University — support may continue, but often not the full table amount.</li>
<li>Even if the claim looks like nonsense, you still have to answer.</li>
</ul>
</div>
