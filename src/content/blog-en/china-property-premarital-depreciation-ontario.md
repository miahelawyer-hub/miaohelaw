---
title: "Ontario Divorce Lawyer Miao He: Does Property in China Have to Be Included? What If It Was Purchased Before Marriage and Has Fallen in Value?"
description: "As long as the spouses’ last common habitual residence was in Ontario, property in China must generally be included in the calculation of Net Family Property. However, property in China is not a matrimonial home under Ontario law. If it was purchased before marriage, its value at the date of marriage may be deducted, and a decline in value may reduce NFP. Miao He is a Toronto Chinese divorce and family litigation lawyer."
pubDate: 2026-08-18T21:00:00-04:00
updatedDate: 2026-08-18T21:00:00-04:00
heroImage: ""
keywords: "property in China Ontario divorce, China real estate NFP, pre-marriage property China, Family Law Act s.15, matrimonial home Ontario, Lau v Tao, exchange rate NFP, Toronto Chinese divorce lawyer, Miao He"
tags:
  ...
  - "ontario-family-law"
pairedArticlePath: "/blog/china-property-premarital-depreciation-ontario/"
...
faqStructured:
  ...
  - question: "I bought that property in China entirely before I got married, and it is registered in my name alone. Does it still have to be included?"
    answer: "Its value at the date of separation is included as an asset. Because the property is in China, s. 28(1) means it is not a matrimonial home under Ontario law, so the “other than a matrimonial home” restriction in s. 4(1) does not apply. If you owned it on the date of marriage, its value at the date of marriage may generally be deducted, regardless of whose name is on title and how often you stayed there during the marriage. What is typically shared is any increase in CAD value between those two dates; a decline can reduce your NFP."
  - question: "Property prices in China have fallen significantly in recent years, and the property is difficult to sell. Will the Ontario court recognize the decrease in value?"
    answer: "The court looks at CAD value on the date of separation, not at how easy the property is to sell. If a pre-marriage property in China declined between the date of marriage and the date of separation, its contribution to NFP can be negative, reducing NFP and the equalization payment. NFP cannot be less than zero under s. 4(5). A decline in the RMB-denominated price and a change in the exchange rate are separate issues and must be proved separately; both dates must be converted into Canadian dollars."
---

<div class="blog-tldr">
<p class="blog-tldr-kicker">Summary</p>
<ul>
<li><strong>Yes.</strong> As long as the spouses’ <strong>last common habitual residence was in Ontario</strong>, real estate, savings, shares, and other assets located in China must be included in the calculation of <strong>Net Family Property (NFP)</strong>.</li>
<li>If the value of a property in China has fallen between the date of marriage and the date of separation, this can be <strong>beneficial</strong> to the spouse who purchased the property before marriage. Because the property is not a matrimonial home under Ontario law, the <strong>“other than a matrimonial home”</strong> restriction in s. 4(1) does not apply to it, and the property’s <strong>value at the date of marriage</strong> may be deducted in the ordinary course.</li>
<li>If a pre-marriage property in China has <strong>decreased in value</strong> between the date of marriage and the date of separation, its contribution to NFP may be negative. This can reduce the spouse’s NFP and, consequently, reduce the equalization payment that spouse may have to pay. This is an issue that is frequently overlooked.</li>
<li>However, NFP cannot be less than zero under <strong>s. 4(5)</strong>. Depreciation can reduce NFP to zero, but it does not create a negative NFP that would require the other spouse to pay money back.</li>
<li><strong>Depreciation must be calculated in Canadian dollars.</strong> A decline in the property's RMB-denominated value and a change in the RMB/CAD exchange rate are two separate issues and must be analyzed separately. Otherwise, the conclusion can be completely different.</li>
</ul>
</div>
...
Under **[s. 15 of the *Family Law Act*](https://www.canlii.org/en/on/laws/stat/rso-1990-c-f3/latest/rso-1990-c-f3.html)**, when a marriage breaks down, property rights are governed by the law of the spouses’ **last common habitual residence**. If that residence was in Ontario, Ontario’s equalization regime applies to the parties’ **property as a whole**, regardless of where the assets are located.
...
This principle is consistent with the reasoning in **[*Lau v. Tao*, 2025 ONCA 819](https://www.canlii.org/en/on/onca/doc/2025/2025onca819/2025onca819.html)**.
...
The Ontario Court of Appeal upheld the conclusion that the property was not a matrimonial home under s. 18(1) because it was not occupied as the spouses’ family residence at the time of separation, relying on **[*Folga v. Folga* (1986), 2 R.F.L. (3d) 358 (Ont. H.C.J.)](https://www.canlii.org/en/on/onsc/doc/1986/1986canlii6331/1986canlii6331.html)**.
...
**Second**, this is simply the normal operation of the NFP calculation. It does not require an argument that the result would be “unconscionable.” The unequal-division provision under **s. 5(6)** is a separate issue and has a very high threshold, as illustrated by **[*Serra v. Serra*, 2009 ONCA 105](https://www.canlii.org/en/on/onca/doc/2009/2009onca105/2009onca105.html)**, at para. 47.
...
1. Did you own the property on the date of marriage?
2. What was its **value at the date of marriage**?
3. What was its value at the date of separation?
4. Was the property located outside Ontario and therefore outside the statutory matrimonial-home regime?
5. Can you provide reliable evidence establishing both values?
6. Have you correctly converted both values into Canadian dollars?
