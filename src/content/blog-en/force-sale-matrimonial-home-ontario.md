---
title: "Your Spouse Won't Sell, Won't Pay and Won't Leave: Forcing the Sale of a Matrimonial Home in Ontario"
description: "Your spouse pays nothing, stays in the house and blocks every sale. How a motion to force sale works in Ontario — and what the court actually orders."
pubDate: 2026-07-25T12:00:00-04:00
updatedDate: 2026-07-25T12:00:00-04:00
heroImage: ""
keywords: "force sale matrimonial home Ontario, motion to sell matrimonial home, Partition Act Ontario, Family Law Act section 21, spouse refuses to sell house Ontario, spouse won't move out, occupation rent Ontario, costs order obstructing sale, house in one spouse's name"
tags:
...
faqStructured:
  ...
  - question: "My spouse pays nothing toward the house. Can I still force a sale?"
    answer: "Yes. Non-payment does not prevent a sale, and it generally strengthens the position of the party seeking one. Where the home is jointly owned, a joint owner has a prima facie right to partition and sale under sections 2 and 3 of the Partition Act, and the fact that the occupying party contributes nothing makes it harder for them to show the malicious, vexatious or oppressive conduct required to resist. Non-payment also supports a separate claim for occupation rent, because Ontario courts specifically weigh whether the occupying spouse paid the mortgage and other carrying charges."
  - question: "Can I force the sale of the matrimonial home in Ontario if my spouse refuses?"
    answer: "If the home is jointly owned, usually yes. Under sections 2 and 3 of the Partition Act a joint owner has a prima facie right to partition and sale, and the court will generally order it unless the resisting party shows the request is malicious, vexatious or oppressive. The ordinary consequences of a sale, such as having to move, disliking the timing of the market, or losing a home of sentimental value, do not meet that threshold. Where the sale is sought before the parties' Family Law Act claims are finally determined, the court also considers whether a sale would prejudice those claims, and usually answers that concern by directing that the net proceeds be held in trust rather than distributed."
  - question: "Can I force a sale if the matrimonial home is registered only in one spouse's name?"
    answer: "Yes. The Partition Act requires that the party seeking the sale have an interest in the land, not that their name appears on title. Section 2 reaches all parties interested in, to or out of any land in Ontario, and applies whether the estate is legal and equitable or equitable only, while section 3(1) allows any person interested in land to bring the application. Under Part II of the Family Law Act a matrimonial home is treated differently from every other asset: both spouses have rights in it regardless of whose name is on title, including an equal right of possession. The interest question is therefore already answered for a matrimonial home, and either spouse may seek a sale. In one of our files the opposing party resisted on the basis of sole registration and a parental loan, and the court held that because both parties have an interest in a matrimonial home the property could be sold."
  - question: "The matrimonial home is in my spouse's name only. Do I have any rights?"
    answer: "Yes. As a married spouse you have an equal right to possession of the matrimonial home regardless of whose name is on title, and under section 21 of the Family Law Act it cannot be sold or mortgaged without your written consent or a court order. You also have an interest in the land for the purposes of the Partition Act, which means you can apply for a sale yourself rather than only being able to block one. This is different from an investment property held in one name, where a beneficial interest would first have to be established through a resulting trust, a constructive trust, or a determination of title between spouses."
  - question: "The matrimonial home is in my name only. Can I just sell it?"
    answer: "Not on your own. Section 21 of the Family Law Act prohibits disposing of or encumbering a matrimonial home without the other spouse's written consent or a court order, even where you are the sole registered owner, and a purchase agreement signed without that consent can be set aside. What that provision blocks is a unilateral private sale, not a court-ordered one. If the other spouse will not consent, you can bring a motion for sale, and the court order supplies what the consent would have. A spouse who refuses to sign has a veto over selling by agreement, not over the court."
  - question: "What about an investment property that is not the matrimonial home?"
    answer: "The analysis differs and title matters. If the investment property is jointly owned, the ordinary Partition Act route applies and a joint owner has a prima facie right to partition and sale. If it is registered in one name only, there is no matrimonial home to supply the interest, so the interest must be established first, through a resulting trust, a constructive trust based on unjust enrichment, or a determination of questions of title between spouses under section 10 of the Family Law Act. Once that determination is made the parties are co-owners in equity and the Partition Act route opens. Where a trust claim is asserted but not yet determined, a court may decline to deal with the sale until ownership is resolved, so the practical sequence is to establish the interest first and seek partition second."
  - question: "Can I change the locks on the matrimonial home?"
    answer: "No. Under the Family Law Act married spouses have an equal right to possession of the matrimonial home regardless of whose name is on title, and that right continues until the property is sold or a court makes an order for exclusive possession. Changing the locks or otherwise excluding a spouse without a court order is not permitted and generally damages the position of the person who does it. If you need the other party out, the remedies are an order for exclusive possession, which is granted cautiously and in exceptional circumstances, or a sale order that includes a date to vacate."
  - question: "Can the court set a deadline for the sale of the house?"
    answer: "Yes, and it is worth asking for one. Ontario courts commonly impose a timetable rather than a bare direction to sell: a date by which the property must be listed, the choice of agent or a mechanism for choosing one, the initial listing price or a method for setting it, a requirement to accept any offer within a defined percentage of the list price, scheduled price reductions if no offer is received, and a date by which the occupying party must vacate. A general order to sell is easy to frustrate through inaction, while a timetable converts obstruction into a breach of a court order."
  - question: "If we sell before agreeing how to divide the money, do I lose my claim?"
    answer: "No, provided the proceeds are properly secured. Where the parties cannot agree how the money should be divided, the standard mechanism is for the net sale proceeds to be held in trust pending agreement or further order of the court. Each party's claim survives and simply attaches to a fund instead of to a property. This is why an agreement to sell can often be reached even when an agreement to divide cannot: agreeing to sell is not agreeing to any division, and selling converts a depreciating, cost-generating asset into a preserved one."
  - question: "Do I have to wait until the divorce and property division are finalized before selling?"
    answer: "No. A sale can be sought on an interim basis before the equalization claim is determined, and this is common where carrying costs are unsustainable or the mortgage is in arrears. The court considers whether an early sale would prejudice either party's Family Law Act claims, and where that is the concern the usual answer is not to refuse the sale but to direct that the net proceeds be held in trust pending agreement or further order."
  - question: "What happens if my spouse obstructs the sale after the court orders it?"
    answer: "It stops being a negotiating position and becomes non-compliance with a court order. The available responses include a further motion for directions, an order giving one party sole carriage of the sale so that they can sign and decide everything alone, and costs. Under the Family Law Rules the successful party on a motion is presumed to be entitled to costs, and unreasonable or bad-faith conduct can increase the award substantially. In one of our files the obstructing party was ordered to pay $5,000 in costs, with the court confirming that the sale would proceed and was not open to further negotiation."
  - question: "What is occupation rent and can I claim it in Ontario?"
    answer: "Occupation rent is compensation payable by a spouse who has had exclusive use of the matrimonial home after separation, to the spouse kept out of it. It is available under section 24 of the Family Law Act and also as an equitable remedy, and it is discretionary rather than automatic. Courts weigh the conduct of both spouses, whether the occupying spouse paid the mortgage and carrying costs, whether children live in the home, delay in bringing the claim, the extent to which the excluded spouse has been prevented from accessing their equity, and whether the excluded spouse moved for a sale of the home. Where the occupying spouse paid all the carrying costs the claim is often reduced or offset entirely; where they paid nothing it is considerably stronger."
  - question: "Does waiting to bring the motion hurt my case?"
    answer: "Yes, in two distinct ways. On a claim for occupation rent, delay is an express factor, and Ontario courts consider whether the non-occupying spouse moved for a sale and if not why not, so years of tolerating the arrangement invite the inference that it was acceptable. Financially, every month of delay allows mortgage interest, taxes, insurance and maintenance to accumulate, and where the mortgage falls into arrears, penalties and enforcement risk erode the very equity both parties are arguing over. Neither problem is cured by waiting for the case as a whole to be resolved."
  - question: "When will an Ontario court refuse to order the sale of a matrimonial home?"
    answer: "Refusals generally rest on a demonstrated competing interest rather than reluctance to move. The main grounds are a substantiated claim for exclusive possession under section 24 of the Family Law Act, genuine prejudice to the resisting party's Family Law Act claims that could not be answered by holding the proceeds in trust, serious disruption to children beyond what separation itself causes, conduct by the party seeking sale that is malicious vexatious or oppressive, or circumstances where no party gains any practical advantage from selling because the proceeds would sit in trust in any event. Inconvenience, attachment to the home and dissatisfaction with market timing are not sufficient."
  - question: "What evidence do I need for a motion to force the sale of a house?"
    answer: "The strongest records are documentary and contemporaneous. Useful materials include mortgage statements showing who has paid and any arrears, property tax and insurance records, utility and maintenance invoices, bank records tracing the payments, correspondence in which a sale was proposed and refused or ignored, evidence of the other party's ability to contribute, and a realtor's opinion of value or an appraisal. Where the property is in one spouse's name alone, evidence going to why the refusal to consent is unreasonable is central, because the onus rests on the non-consenting spouse to justify it."
...
<ul>
<li><strong>Jointly owned home:</strong> a joint owner has a <em>prima facie</em> right to partition and sale under the [*Partition Act*](https://www.canlii.org/en/on/laws/stat/rso-1990-c-p4/latest/rso-1990-c-p4.html), ss. 2–3.</li>
<li><strong>Matrimonial home in one name?</strong> Still the Partition Act. It requires an <strong>interest</strong>, not a name on title — and <strong>both spouses have an interest in a matrimonial home</strong>.</li>
<li><strong>Investment property in one name?</strong> Different — the interest must be <strong>determined first</strong> (trust claim, or a determination of title), then partition follows.</li>
<li>The court can order a <strong>timetable</strong>, not just a sale: list by a date, price reductions, and a date to <strong>vacate</strong>.</li>
<li>Net proceeds are commonly <strong>held in trust</strong>, so neither party gives up any claim by selling.</li>
<li><strong>Delay costs you twice</strong> — it erodes the equity, and it weakens a later occupation rent claim.</li>
</ul>
</div>
...
**My spouse won't move out. What can I do?**
Bring a motion for sale. Where a court orders a sale it can also order the occupying party to **vacate by a set date** and permit showings — and if they will not cooperate, give you **sole carriage of the sale**, meaning you sign and decide everything alone.

**My spouse pays nothing toward the house. Can I still force a sale?**
**Yes.** Non-payment does not block a sale. It usually helps you — both on the motion and on a later claim for occupation rent.

**The matrimonial home is in my spouse's name only. Can I force a sale?**
**Yes.** The *Partition Act* requires that you have an *interest* in the land — not that your name is on title. **In a matrimonial home, both spouses have an interest**, so either can apply.

**The matrimonial home is in my name only. Can I just sell it?**
**Not on your own.** Section 21 of the [*Family Law Act*](https://www.canlii.org/en/on/laws/stat/rso-1990-c-f3/latest/rso-1990-c-f3.html) means you cannot list and close without your spouse's consent **or a court order**. You can still ask the court for the sale.

**Can I change the locks?**
**No.** Married spouses have an equal right to possession until the home is sold or a court orders exclusive possession.

**What about an investment property, not the matrimonial home?**
**If it's jointly owned**, the same *Partition Act* route applies. **If it's in one name only**, the interest has to be established first — then the sale follows.

**Do I have to wait until the divorce is finished?**
**No.** A sale can be ordered on an interim basis, with the net proceeds held in trust.

**If we sell before agreeing how to split the money, do I lose out?**
**No.** Proceeds are held in trust. **Agreeing to sell is not agreeing to any division.**

**My spouse agreed, then refused to sign the listing. Now what?**
Ask for **sole carriage of the sale** — you sign everything and make every decision without them — plus **costs**. In one of our files the obstructing party was ordered to pay **$5,000** in costs.

**Is it too late if I have put up with this for years?**
No, but delay works against you — financially, and on an occupation rent claim, where courts specifically ask whether you moved for a sale and, if not, why not.
...
| Property | On title | Route |
|---|---|---|
| **Matrimonial home** | Joint **or one name only** | ***Partition Act*, ss. 2 and 3.** Both spouses have an interest in a matrimonial home, so either can apply for a sale. |
| **Investment or other property** | Jointly owned | ***Partition Act*, ss. 2 and 3.** Straightforward. |
| **Investment or other property** | One name only | **The interest has to be determined first** — resulting trust, constructive trust, or a determination of title between spouses. Then the *Partition Act*. |
