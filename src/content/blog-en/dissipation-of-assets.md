...
1. What assets existed (bank statements, investment records, property records)
2. What happened to them (withdrawals, transfers, sales)
3. That the dissipation was deliberate and not justified
4. The value of what was dissipated
...
1. **Gather documentation immediately** — bank statements, transaction records, account numbers
2. **Do not delay** — the longer you wait, the harder it becomes to trace assets and the greater the dissipation
3. **Seek an Asset Preservation Order** as soon as possible if the risk is ongoing
4. **Consult a lawyer with cross-border capability** if assets may be in China
