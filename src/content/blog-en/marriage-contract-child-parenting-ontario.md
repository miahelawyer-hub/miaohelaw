...
tags:
  ...
  - "ontario-family-law"
pairedArticlePath: "/blog/marriage-contract-child-parenting-ontario/"
relatedIntro: "What a contract can lock, what it cannot, and when a signed contract can still be set aside are three different questions:"
relatedReading:
  - href: /en/family-law/domestic-contracts/
    title: Marriage and separation agreements
    line: What prenuptial, during-marriage, separation and cohabitation agreements can cover.
  - slug: prenuptial-agreement-ontario-2026
    line: What a marriage contract can do in Ontario, and the usual misconceptions.
  - slug: prenuptial-agreement-validity-ontario
    line: After you sign, when a court will set the contract aside.
  - slug: child-custody-ontario-chinese
    line: What courts actually look at for decision-making and parenting time.
...
faqStructured:
  ...
  - question: "Can we agree in advance that after separation the child will live with one parent?"
    answer: "No. You can't do it in a prenup or postnup, it's invalid even if you write it. Only a separation agreement can deal with parenting arrangements. And even then, the court can change it based on the child's best interests."
  - question: "What about a prenup?"
    answer: "No. Same. Signed before or after marriage, it's still a marriage contract under s. 52. Neither can decide the child."
  - question: "Is 'no child support' enforceable?"
    answer: "No. Child support is the child's right. Parents can't use it to offset debts between themselves. If the court finds it unreasonable, it will ignore it."
  - question: "Can a forced agreement be set aside?"
    answer: "It's not automatically void, but it can be set aside. Possibly. Depends on the evidence. No disclosure, didn't understand what you were signing, duress, undue influence, misrepresentation — all can be grounds under s. 56(4)."
---
