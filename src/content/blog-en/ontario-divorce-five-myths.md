...
relatedReading:
  - slug: ontario-divorce-timeline-2026
    line: "Contested and uncontested timelines help you see where a divorce order fits relative to earlier court steps."
...
faqStructured:
  - question: "Do I have to wait one full year of separation before I can go to court in Ontario?"
    answer: "No single rule blocks every court step until the calendar hits twelve months. You can start a divorce application and pursue corollary relief depending on your facts. A no-fault divorce grounded in one-year separation still requires meeting the statutory separation period before a divorce order is granted on that basis; adultery and cruelty involve different requirements. Strategy should be confirmed with counsel."
  - question: "Can we be legally separated if we still live in the same home?"
    answer: "Sometimes yes. Ontario courts look at whether the relationship has ended in substance — living arrangements, finances, and social roles — not only whether someone moved out."
  - question: "If family law says we are separated, does CRA agree for tax and benefits?"
    answer: "Not automatically. CRA applies its own tests for marital status and benefits. Family law labels and tax outcomes can diverge; get advice where numbers or benefits matter."
  - question: "Does low or no income mean I cannot get parenting time or decision-making authority?"
    answer: "Income matters for support calculations, but it is not the only lens for parenting outcomes. The child’s best interests drive the analysis, alongside safety, stability, caregiving history, and other factors."
  - question: "Can I withhold parenting time if the other parent stops paying child support?"
    answer: "Self-help is risky. Support enforcement runs through court processes and, where applicable, the Family Responsibility Office (FRO). Cutting off parenting time over unpaid support can backfire in parenting litigation."
---
...
Under Canada’s [*Divorce Act*](https://laws-lois.justice.gc.ca/eng/acts/d-3.4/), a breakdown of marriage can be established in several ways, including one-year separation, adultery, and cruelty, each with its own requirements.

What usually matters in real life:

- You can file an [**Application for Divorce**](https://laws-lois.justice.gc.ca/eng/acts/d-3.4/) **with the court at any time**, together with related materials, without treating “one year” as a wall before every procedural step.
- In a **cooperative, no-fault** path where the parties rely on **one year of separation** as the breakdown ground, the **divorce order** typically comes **after** the statutory separation period is satisfied — that is the step people colloquially tie to “getting the certificate.” It does **not** mean every [**contested divorce**](/en/family-law/divorce-litigation/) must sit idle for twelve months before anything is filed.
- When a case is [**high-conflict**](/en/family-law/divorce-litigation/), you **do not** need to wait until you have completed one year of separation before filing an [**Application for Divorce**](https://laws-lois.justice.gc.ca/eng/acts/d-3.4/) or taking other court steps. The one-year rule is **not a restrictive “start line”** that blocks litigation; it still matters for **when** a court may grant a divorce on a no-fault, one-year-separation ground, but it should not freeze strategy when parenting, support, or safety issues need early judicial attention.
...
Canada Revenue Agency applies **its own** marital-status rules for tax and benefits. A “separation” finding for [**family law**](/en/family-law/) purposes does not automatically sync with CRA’s view.

**Note:** treat tax and benefits as a **second checklist**. Where filings or credits are sensitive, use CRA’s current guidance (for example via [Canada.ca](https://www.canada.ca/en.html)) and loop in professionals when the fact pattern is messy. If you want the family-law story and the tax narrative to stay consistent, **contact our office early** — we map the steps many GTA clients need before numbers and deadlines lock in.

---

## Mistakes people make about income and parenting outcomes

Statutory language has shifted. Under the modern *Divorce Act* framework, courts emphasize **decision-making responsibility** and **parenting time**, anchored in the **best interests of the child**. Income is highly relevant to [**child support**](/en/family-law/support/), but it is not a simple on-off switch for whether a parent may have parenting time or a voice on major decisions.
...
In Ontario, [**child support**](/en/family-law/support/) enforcement and **parenting time** are legally distinct channels. Withholding [**parenting time**](/en/family-law/child-custody/) to punish non-payment looks like self-help and can damage your position in parenting litigation, even where support arrears are real.
...
- The Ontario [**Family Responsibility Office (FRO) online portal**](https://www.froonline.mcss.gov.on.ca/#/auth/login) for eligible enforcement steps.
...
1. [**Divorce**](/en/family-law/divorce-litigation/) — ending the marriage and the divorce order itself.  
2. [**Parenting**](/en/family-law/child-custody/) — decision-making and parenting time in the child’s interests.  
3. [**Support and money**](/en/family-law/support/) — child support, spousal support where applicable, and tax/benefits hygiene.
...
📞 **647-930-6688** · [Book a consultation](/en/contact/)
