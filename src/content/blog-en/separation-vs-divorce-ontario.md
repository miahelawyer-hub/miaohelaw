...
faqStructured:
  ...
  - question: "Can you legally separate while still living under the same roof?"
    answer: "Yes. Canadian law recognizes separation under one roof. What matters is whether the couple has substantively stopped living as spouses — separate bedrooms, separate finances, separate social lives. Physical co-habitation does not prevent a valid separation."
  - question: "How long do you need to be separated before filing for divorce?"
    answer: "To file for divorce on the ground of marriage breakdown, you generally need to have been separated for one year. You may also file on grounds of adultery or physical or mental cruelty, but the one-year separation ground is by far the most common in practice."
  - question: "Do you need a separation agreement?"
    answer: "Not legally required, but strongly recommended. A separation agreement sets out each party's rights and obligations on property division, spousal support, and parenting — and protects both parties before formal divorce proceedings begin."
---

<div class="blog-tldr">
  <p class="blog-tldr-kicker">Key Takeaways</p>
  <ul>
    <li>Separation is a factual state — no court, no paperwork required. Divorce is a legal process that requires a court order.</li>
    <li>Separation is reversible: if you resume living together for more than 90 days, the separation ends and your separation date resets.</li>
    <li>You can separate under one roof — what matters is whether you have substantively stopped living as spouses.</li>
    <li>Divorce is not reversible: once the divorce order is granted, remarrying requires a completely new marriage registration.</li>
    <li>Years of separation never automatically end a marriage — you must actively apply for divorce, or the marriage continues indefinitely.</li>
  </ul>
</div>
