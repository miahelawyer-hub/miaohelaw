...
relatedReading:
  - slug: "ontario-restraining-order-chinese-family"
    line: "Companion piece: how restraining orders work in family court — evidence, urgent motions, and common concerns for Chinese-Canadian families."
  - slug: "child-custody-ontario-chinese"
    line: "Parenting disputes: decision-making responsibility, parenting time, and what courts emphasize under the best-interests framework."
  - slug: "spousal-child-support-ontario"
    line: "Child support, spousal support, and FRO enforcement when payments stop or fall behind."
  - slug: "separation-vs-divorce-ontario"
    line: "Why separation and divorce are different steps in Ontario — and why \"faster divorce\" rarely turns on fault alone."
faqStructured:
  - question: "If Ontario divorce is no-fault, does domestic violence have zero impact on the outcome?"
    answer: "No-fault mainly shapes which statutory ground ends the marriage (often one-year separation) and the starting framework for equalization of net family property. It does not mean family violence is irrelevant to parenting, safety planning, exclusive possession of the matrimonial home, interim motions, or how a judge assesses credibility and risk."
  - question: "Where does domestic violence matter most in parenting disputes?"
    answer: "In parenting applications, courts apply a best-interests analysis under the Children's Law Reform Act and the Divorce Act. Family violence, coercion, and safety risks are among the factors that can weigh heavily on decision-making responsibility, parenting time, and conditions such as supervision — always tied to evidence and fact-finding."
  - question: "Can I get a faster divorce by proving adultery or abuse?"
    answer: "In contested cases, the procedural backbone — conferences, motions, disclosure, and possibly trial — often remains. Abuse may change urgency for interim orders, but it usually does not erase the structured dispute-resolution path."
  - question: "Will calling the police make me lose my children?"
    answer: "If a report is fabricated to gain a tactical advantage, credibility damage can be severe. Where risk is real, timely documentation and lawful protective steps are often aligned with children's safety. Every case turns on facts and proof."
  - question: "Is a restraining order the first legal step?"
    answer: "In many high-risk scenarios, civil restraining orders and urgent motions in family court are important tools — but they have evidentiary thresholds and strategic trade-offs. Immediate danger should be reported to 911."
  - question: "Does abuse change equalization of net family property?"
    answer: "Equalization is not a moral fault contest. In extreme circumstances, violence-related impacts on earning capacity, health costs, disclosure, or costs awards may interact with financial issues — but broad generalizations are risky without individualized advice."
---
...
For a structured overview of the parenting framework, start with the firm's **[child custody and parenting hub](/en/family-law/child-custody/)**, then the deeper article **[Child custody and parenting time in Ontario: a practical guide](/en/blog/child-custody-ontario-chinese/)**.
...
For support and enforcement pathways, start with **[support and child support](/en/family-law/support/)**; for non-payment, see **[When the other side will not pay support in Ontario](/en/blog/spousal-child-support-ontario/)**. For income manipulation in guideline calculations, see **[Imputed income and child support in Ontario](/en/blog/imputed-income-child-support-ontario/)**.
...
- Texts, emails, voicemails — timelines matter (see **[electronic evidence in Ontario family court](/en/blog/electronic-evidence-ontario-family-court/)**)  
