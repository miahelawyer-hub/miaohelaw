---
title: "Uncontested Divorce in Ontario: Forms, Fees and Why Simple Files Stall (2026 Guide)"
description: "Ontario uncontested divorce, 2026: the forms, the court fees, and the seven procedural failures that turn a simple divorce into a two-year file."
pubDate: 2026-07-25T12:00:00-04:00
updatedDate: 2026-07-25T12:00:00-04:00
heroImage: ""
keywords: "uncontested divorce Ontario, simple divorce Ontario, joint divorce Ontario, Form 8A, Form 36, Certificate of Divorce Ontario, divorce court fees Ontario, serving divorce papers China, stalled divorce application Ontario"
tags:
  ...
  - "ontario-family-law"
  - "miao-he-lawyer"
pairedArticlePath: "/blog/uncontested-divorce-ontario/"
relatedIntro: "Read these alongside this guide:"
relatedReading:
...
faqStructured:
  ...
  - question: "Can I get divorced in Ontario if my spouse refuses to sign the papers?"
    answer: "Yes. If your spouse will not cooperate but does not actively oppose the divorce, you can proceed by way of a simple divorce. Provided the respondent has been properly served and files no Answer within 30 days (60 days if served outside Canada or the United States), the application continues on an uncontested basis."
  - question: "What is the difference between a joint divorce and a simple divorce in Ontario?"
    answer: "In a joint divorce both spouses prepare and sign the application together, neither is applicant or respondent, and no service is required. In a simple divorce one spouse applies for a divorce only, and the other spouse must be formally served and given 30 days to respond. Agreement to divorce and willingness to sign court forms are different things: where a spouse agrees in principle but will not attend to paperwork, a simple divorce is usually the correct route."
  - question: "Can I remarry as soon as the judge signs my Ontario divorce order?"
    answer: "No. Under section 12(1) of the Divorce Act, the divorce takes effect on the 31st day after the Divorce Order is made. You will also need the Certificate of Divorce (Form 36B), which must be requested separately from the court, as proof of dissolution before a marriage licence will be issued. It is not sent to you automatically."
  - question: "We were married in China. Can we get divorced in Ontario?"
    answer: "Yes, provided one spouse has been habitually resident in Ontario for at least one year immediately before the application is filed, as required by section 3 of the Divorce Act. Where you were married is irrelevant to jurisdiction. The marriage is generally recognized if it was validly celebrated under the law of the place where it took place, and you will need the official marriage record with a certified translation into English or French."
  - question: "How do I serve divorce papers on a spouse living in China?"
    answer: "Service on a spouse in China extends the time to answer to 60 days and must comply with the Hague Service Convention, to which China is a party. Documents are transmitted through the designated Chinese Central Authority rather than delivered privately, translations into Chinese are required, and you must prove to the Ontario court that service satisfied both the Convention and Ontario's service rules. This commonly adds several months and should be planned before the application is issued."
  - question: "My marriage certificate is in Chinese. What does the Ontario court require?"
    answer: "You must file the original marriage certificate or marriage registration certificate together with a certified translation into English or French. A translation prepared by a friend, relative or uncertified service will not be accepted. Common complications include a lost original where only a photocopy survives, names recorded in Chinese characters that do not match the pinyin or anglicized names on Ontario identification, and marriages requiring proof of a prior divorce or the death of a former spouse. Name discrepancies must be explained on affidavit in the Form 36."
  - question: "What if I cannot locate my spouse to serve the divorce application?"
    answer: "Depending on the efforts already made to locate them, the court may permit substituted service or, in appropriate cases, dispense with service entirely. Both require a motion supported by affidavit evidence of your documented search efforts. Abandoning the application is the one response that guarantees the divorce is never granted."
  - question: "I filed a divorce application years ago and it was never finished. Can it still be completed?"
    answer: "Usually yes. Dormant divorce files are almost always stalled for procedural rather than substantive reasons: an unanswered court requisition, a respondent who was never successfully served, an application filed on the wrong procedural footing, or a Divorce Order granted where the Certificate of Divorce was never requested. Completing the file requires reconstructing the court record, identifying what is missing, and in some cases bringing a motion."
  - question: "The court sent me a requisition. Does that mean my divorce was refused?"
    answer: "No. A requisition means the court requires additional information or corrections before granting the Divorce Order. Most concern straightforward matters such as unsigned affidavits, name inconsistencies, unclear separation dates or insufficient child support evidence. Responding promptly and completely is essential — unanswered requisitions are the most common reason uncontested divorce files remain dormant for years."
  - question: "Does an Ontario divorce automatically divide property?"
    answer: "No. A Divorce Order ends the marriage only. Equalization of net family property, the matrimonial home, pensions, businesses, support and parenting are separate matters. Importantly, under section 7(3) of the Family Law Act, a divorce starts a two-year limitation period for bringing an equalization claim, so property issues should be addressed before the divorce is finalized."
---

<div class="blog-tldr">
<p class="blog-tldr-kicker">In short</p>
<ul>
<li>An uncontested divorce is decided on paper by a judge in chambers — no hearing, usually no court appearance.</li>
<li>Court fees come to roughly <strong>$700</strong> in total (as at July 2026), across two filing stages plus the certificate.</li>
<li>The forms that matter: <strong>Form 8A</strong>, <strong>Form 6B</strong>, <strong>Form 36</strong>, <strong>Form 25A</strong>, <strong>Form 36B</strong>.</li>
<li>"Uncontested" describes the spouses, not the paperwork. Files stall on procedure, not on disagreement.</li>
<li>A Divorce Order does not divide property — and it starts a <strong>two-year</strong> limitation clock on equalization.</li>
</ul>
</div>
...
| Item | Detail |
|---|---|
| **Governing law** | *Divorce Act*, R.S.C. 1985, c. 3 (2nd Supp.); *Family Law Act*, R.S.O. 1990, c. F.3; Family Law Rules, O. Reg. 114/99 |
| **Court** | Superior Court of Justice, or its Family Court branch |
| **Residency test** | One spouse habitually resident in Ontario for 1 year before filing (*Divorce Act*, s. 3) |
| **Usual ground** | One year living separate and apart (*Divorce Act*, s. 8) |
| **Key forms** | Form 8A (Application – Divorce), Form 6B (Affidavit of Service), Form 36 (Affidavit for Divorce), Form 25A (Divorce Order), Form 36B (Certificate of Divorce) |
| **Court fees** | Roughly **$700** total — as at July 2026: $214 filing + $10 federal registry + $445 listing + $25 certificate. Set by regulation; periodically increased |
| **Online filing – Toronto** | Ontario Courts Public Portal (OCPP), mandatory since October 14, 2025 |
| **Online filing – outside Toronto** | Justice Services Online |
| **Response period** | 30 days (60 days if served outside Canada or the U.S.) |
| **Divorce takes effect** | 31st day after the Divorce Order (*Divorce Act*, s. 12(1)) |
...
|---|---|---|
| **Joint divorce** | Both spouses prepare and sign together. Neither is applicant or respondent. **No service required.** | Both cooperative, available, willing to sign. Skipping service and the response period typically saves four to eight weeks. |
| **Simple divorce** | One spouse applies for a divorce **only** — no claims for support, property or parenting. The respondent is served and files no Answer. | Your spouse agrees the marriage is over but will not sign documents; or everything is already settled by [separation agreement](/en/blog/separation-agreement-vs-divorce-ontario/). |
| **Uncontested by default** | The respondent is properly served and never responds within the deadline. | Your spouse is disengaged, unreachable, or deliberately ignoring the proceeding. |
...
- **Toronto region** → **Ontario Courts Public Portal (OCPP)**, mandatory since **October 14, 2025**
- **Everywhere else in Ontario** → **Justice Services Online**
...
|---|---|---|
| Preparing and issuing the application | 2–5 weeks | You (or your lawyer) |
| Central Registry Clearance Certificate | 4–6 weeks | Federal registry — unfixable, but must be tracked |
| Service on the respondent | 1–4 weeks, longer abroad | You, plus the other side's availability |
| Response period | 30 or 60 days | Fixed by rule |
| Filing the divorce package | 1–2 weeks | You |
| Judicial review | Varies by region | The court |
| Responding to a requisition | **Days, or years** | **Entirely you** |
| Appeal period | 31 days | Fixed by statute |
| Requesting the certificate | 1–3 weeks | **Entirely you** |
...
For a full stage-by-stage breakdown of durations, see our [Ontario divorce timeline](/en/blog/ontario-divorce-timeline-2026/).
...
| **Court fees subtotal** | **approximately $700** |
| Process server | typically $100–$200 |
| Certified translation of foreign marriage documents | varies |
| International service under the Hague Convention | varies, often substantial |
...
These are court fees only. On legal fees and what drives them, see [Toronto Divorce Lawyer Fees Explained](/en/blog/toronto-divorce-lawyer-fees-3000-vs-30000/).
...
Four to eight months to the Divorce Order for a well-managed file, plus 31 days before it takes effect and one to three weeks for the certificate. We break the stages down in detail in our [Ontario divorce timeline](/en/blog/ontario-divorce-timeline-2026/).
...
No — it is not a legal prerequisite. But if property, support or parenting issues are unresolved, get advice **before** finalizing the divorce. See Section 7, and our note on [separation agreements and divorce](/en/blog/separation-agreement-vs-divorce-ontario/).
