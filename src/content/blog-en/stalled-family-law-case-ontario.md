---
title: "When a Family Law Case Stalls in Ontario: Why It Happens and How to Break the Deadlock (2026)"
description: "Two years, no movement, rising fees. Why Ontario family law cases stall, and how separating the sale question from the division question breaks a deadlock."
pubDate: 2026-07-25T12:00:00-04:00
updatedDate: 2026-07-25T12:00:00-04:00
heroImage: ""
keywords: "family law case stalled Ontario, divorce case not progressing, changing divorce lawyer Ontario, partition and sale matrimonial home Ontario, sale proceeds held in trust, Partition Act Ontario, breaking deadlock divorce negotiation"
tags:
...
faqStructured:
  ...
  - question: "I have spent a lot on legal fees and nothing has happened. What should I do?"
    answer: "Before changing anything, establish which of two situations you are in. A slow file still advances: disclosure gets exchanged, issues narrow, offers move, even if the pace is frustrating. A stuck file repeats the same positions in different words. If the file is stuck, more of the same activity will not change the outcome, and the strategy itself needs to be re-examined rather than pursued more forcefully. Ask your lawyer directly what they would do differently given that the current approach has not worked, and what the objective of the next step is, not just what the step is."
  - question: "How do I know whether my case is stuck or just slow?"
    answer: "Ask whether your position is closer to resolution than it was six months ago, or merely more expensive. Slow files still advance: financial disclosure gets exchanged, the number of disputed issues shrinks, settlement offers move toward each other. Stuck files repeat. If the same argument has been made three times in different letters, the file is stuck, and further correspondence will not change that. The distinction matters because slowness usually calls for patience while a genuine deadlock calls for a change of approach."
  - question: "What is the difference between a lawyer taking instructions and a lawyer giving advice?"
    answer: "Both are legitimate services. Taking instructions means carrying out the steps a client directs: the client decides the objective and the route, and counsel executes competently. Giving advice means assessing whether those steps will achieve what the client actually wants, and saying so when they will not. Many people believe they have retained the second and discover, after considerable expense, that they received the first. Rowing and steering are different jobs: knowing the law is the entry requirement, while deciding which of several legally available routes will actually reach the objective is judgment. A stalled file needs the second."
  - question: "How can I tell whether my family lawyer is doing a good job?"
    answer: "Four questions answer this without requiring any legal knowledge. First, is the current position closer to resolution than six months ago, or only more expensive? Second, has anyone ever told you your plan will not work? If every proposal you made was executed without challenge, you may be buying execution rather than advice. Third, can your lawyer state the objective of the next step, not just the step itself? Sending a letter is an action; building a record for a motion to be brought in September is an objective. Fourth, has the strategy ever been re-examined, or only pursued harder? A file that has had the same plan for two years has, in effect, never had that plan tested."
  - question: "Should I change lawyers if my family law case has stalled?"
  ...
  - question: "The mortgage is in arrears and my spouse will not agree to sell. What happens?"
    answer: "Arrears change the analysis significantly because delay stops being neutral. Interest and penalties accumulate, enforcement by the lender becomes a live risk, and the equity both parties are arguing over shrinks every month. A spouse resisting sale in those circumstances must be able to identify a real competing interest under the Family Law Act, such as a substantiated claim for exclusive possession, rather than a preference for deferring the outcome. Where no such interest exists, the objection is difficult to sustain, and counsel on both sides can usually see that."
  - question: "Why would the other side agree to sell if we cannot agree on anything else?"
    answer: "Because the sale question and the division question have different incentive structures. On division the parties are in pure opposition: what one gains the other loses, so neither has a reason to move first. On sale their interests frequently align, because continued delay imposes carrying costs, mortgage interest, deterioration and market risk on both of them, and those costs come out of the equity they are both claiming. Separating the two questions allows agreement on the one where interests align while deferring the one where they do not, provided the value is preserved in the meantime."
...
1. **Is the current position closer to resolution than it was six months ago — or only more expensive?** Slow files still advance: disclosure gets exchanged, issues narrow, offers move. Stuck files repeat.
2. **Has anyone ever told you your plan will not work?** If every proposal you have made has been executed without challenge, you may be buying execution rather than advice.
3. **Can you state the objective of the next step, not just the step?** "We are sending a letter" is an action. "We are creating a record for a motion we intend to bring in September" is an objective. Only one of those is a strategy.
4. **Has the strategy ever been re-examined, or only pursued harder?** A file that has had the same plan for two years has, in effect, never had the plan tested.
