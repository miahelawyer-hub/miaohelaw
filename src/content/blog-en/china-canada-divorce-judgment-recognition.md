...
relatedReading:
  ...
  - slug: chinese-divorce-property-gift-loan-trust-ontario
    line: Parental down payments, nominee holders, and family trusts — how cross-border arrangements are unwound at divorce.
  - slug: expert-witness-chinese-marriage-law-ontario
    line: Using a PRC marriage-law expert in Ontario family court — when, why, and what evidence carries weight.
faqStructured:
  - question: "Will a Chinese divorce judgment be automatically recognized in Canada?"
    answer: "No. Clients must go through a separate two-step Canadian process: first apply for Recognition, then for Enforcement. At the recognition stage, the Canadian court reviews whether the Chinese judgment conflicts with fundamental Canadian legal principles — such as property division rules, separation date treatment, and excluded property — and may refuse recognition where the conflict is significant."
  - question: "Can a Canadian divorce judgment be used to divide property located in China?"
    answer: "No. Chinese courts strictly preserve their judicial sovereignty and recognize only the dissolution of the marital status itself in foreign divorce judgments. The property division portion of a Canadian judgment cannot be enforced by Chinese courts against Chinese real estate, deposits, or equity holdings."
  - question: "If most of our assets are in Canada, do I need to file in China?"
    answer: "Strongly discouraged. Ontario courts adjudicate worldwide assets and can use an Equalization Set-off to offset minor Chinese-located assets when dividing the Canadian portion. All execution happens inside Canada — there is no need to actually liquidate the Chinese property or rely on a Chinese court."
...
<div class="blog-tldr">
  ...
  <ul>
    <li>A Chinese divorce judgment is not automatically valid in Canada — recognition is a separate, refusable step.</li>
    <li>A Canadian judgment can dissolve the marriage in China but cannot enforce property division against Chinese assets.</li>
    <li>The right forum is determined by where the assets sit, not where it's easier to file.</li>
    <li>When most assets are in Canada, the Ontario court can use an Equalization Set-off to handle minor Chinese assets without cross-border enforcement.</li>
    <li>Once the wrong forum is chosen, there is almost no way to fix it after the fact — strategy must come before filing.</li>
  </ul>
</div>
...
2. Reopen the entire matter and recompute equalization across both spouses' **worldwide assets** under the [*Family Law Act*](https://www.ontario.ca/laws/statute/90f03).
...
| Asset Distribution | Recommended Forum | Why |
|---|---|---|
| ~80% in China | China | Direct enforcement against in-country assets |
| ~80% in Canada | Canada | Worldwide-asset jurisdiction + Set-off mechanism |
| Roughly even | Case-by-case | Place of marriage, residence, and evidence access all matter |

### Common Misconceptions vs. Reality

**❌ Misconception:** *"I have a property in China, so the Chinese house must be sold and divided in China."*
**✅ Reality:** Ontario courts can resolve it via Equalization Set-off — entirely inside Canada.

**❌ Misconception:** *"If I divorce in China first, I can simply use that judgment in Canada."*
**✅ Reality:** It must go through Canadian recognition, and recognition can be refused.

**❌ Misconception:** *"Once I have a Canadian judgment, I can return to China and sell the house."*
**✅ Reality:** Chinese courts only recognize the dissolution — they will not enforce the Canadian property division.
