...
tags:
  ...
  - "ontario-family-law"
pairedArticlePath: "/blog/child-support-waiver-separation-agreement-ontario/"
relatedIntro: "Whether you can waive support, and how you collect if the other parent does not pay, are two different files:"
relatedReading:
  - href: /en/family-law/support/
    title: Child and spousal support
    line: How the two streams differ, and when income is imputed.
  - slug: uncontested-divorce-ontario
    line: Why a simple divorce is sent back when the child-support figure does not match.
  - slug: imputed-income-child-support-ontario
    line: What the court does when a parent quits or under-reports income.
  - slug: spousal-child-support-ontario
    line: Once an amount is set, how FRO enforces if it is not paid.
