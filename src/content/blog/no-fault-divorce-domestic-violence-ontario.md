...
relatedReading:
  ...
  - slug: "spousal-child-support-ontario"
    line: "延伸：子女抚养费、配偶扶养（赡养）的执行框架与不付时的救济路径。"
...
- 短信、微信、邮件、语音留言：注意连续性与时间线（微信与电子证据在安省家庭法庭的采信规则，见 [微信、银行截图、录音能在安省家庭法庭做证据吗？](/blog/electronic-evidence-ontario-family-court/)）  
- 医疗记录、诊断、就诊说明（如有）  
