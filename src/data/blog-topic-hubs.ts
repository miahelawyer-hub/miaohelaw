...
export const blogTopicHubs: BlogTopicHub[] = [
  {
    ...
    chip: '财产分割',
    chipEn: 'Property',
    intro: '婚房、婚前扣除、父母出资、强制出售，NFP 算错了能不能重算，以及均等化时效。',
    introEn: 'The matrimonial home, pre-marriage deductions, parental gifts, forced sale, whether a wrong NFP can be recalculated, and equalization limitation periods.',
    slugs: [
  ...
  },
  {
    ...
    chip: '跨境资产',
    chipEn: 'Cross-border',
    intro: '中国房产、跨境披露、判决互认，新移民担保，以及带孩子搬家或被带回中国。',
    introEn: 'Property in China, cross-border disclosure, recognition of judgments, sponsorship after divorce, and relocating or recovering a child from China.',
    slugs: [
  ...
  },
  {
    ...
    chip: '子女抚养',
    chipEn: 'Children',
    intro: '监护判断标准、带孩子搬家、协议能不能放弃抚养费、推定收入、SSAG，以及中加抚养费认定差异。',
    introEn: 'Best-interests tests, relocation with a child, whether support can be waived, imputed income, SSAG, and China–Canada differences in support.',
    slugs: [
