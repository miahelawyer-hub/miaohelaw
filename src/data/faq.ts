...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    summary: '符合《离婚法》第 22 条时，通常不必在加拿大再离一次。中国判决没分的加拿大财产，安省仍可能走均等化，但要注意第 7(3) 条时效。赡养费不是同一套：为躲义务去境外离的，法院可以不认。',
    answers: [
      '通常不必再离一次。符合联邦《离婚法》第 22 条的外国离婚，安省一般承认身份已经解除。但这不是每份证书都自动过关——为了躲开安省赡养费去境外离的，法院可以不认。',
      '财产是另一件事。中国判决没处理的加拿大房子、账户，仍可能在安省走均等化。时效是离婚后两年、分居后六年，以较早者为准。展开见<a href="/blog/china-divorce-ontario-equalization-afterward/">中国离了婚，安省还能分财产吗</a>。',
    ],
    details: [
      '加拿大《离婚法》第 22 条承认符合条件的外国离婚，常见条件是起诉时前配偶一方已在该国惯常居住至少一年。符合时，不必在安省再走一遍离婚程序。承认规则和执行限制，见<a href="/blog/china-canada-divorce-judgment-recognition/">中国离婚判决在加拿大如何承认</a>。',
      '离婚证只证明婚姻关系可能已经解除，不代表财产已经结清。中国判决没写的加拿大房产、存款、投资，仍可按《家庭法》申请均等化——上诉法院在 Cheng v. Liu 里确认了这条。详见<a href="/blog/china-divorce-ontario-equalization-afterward/">中国离了婚，安省还能分财产吗</a>。',
      '诉讼时效按安省《家庭法》第 7(3) 条：离婚后两年，或分居后六年，或配偶去世后六个月，以最早到期者为准。外国离婚被承认，两年钟可能已经从那张证书的日期起算。',
      '配偶赡养费不要和财产写成一句。外国离婚被承认后，《离婚法》的附带救济通常走不通；若境外离婚就是为了躲安省义务，法院可以不认，赡养费继续审。见<a href="/blog/foreign-divorce-avoid-spousal-support-ontario/">跑到国外离婚，就能躲掉安省赡养费吗</a>。何淼律师持中加双重执照，欢迎致电 647-930-6688。',
    ],
    metaTitle: '在中国已经离婚，还需要在加拿大再离一次吗？| 何淼律师',
    metaDescription:
      '符合条件时通常不必再离一次。中国判决没分的加拿大财产，安省仍可能均等化，但有时效。为躲赡养费去境外离的，法院可以不认。647-930-6688。',
  ...
  },
  {
    ...
    details: [
      ...
      '子女抚养费（Child Support）是孩子的法定权利，不是父母可以协议放弃的选项。即便父母双方都说"我们同意不要抚养费"，法院也不会接受。Child Support的金额按联邦《子女抚养费指引》计算，主要依据支付方的收入和子女人数确定。为什么分居协议里不能放弃，见<a href="/blog/child-support-waiver-separation-agreement-ontario/">分居协议里可以不写子女抚养费吗</a>。',
  ...
  },
  {
    ...
    details: [
      ...
      '抚养费的数额在条件变化后可以申请变更。如果对方隐瞒真实收入，法院可以根据实际情况推定收入（Income Imputation）。分居之后一直没起诉，以前那截不是自动归零，见<a href="/blog/retroactive-child-support-ontario/">分居了没起诉，以前的孩子抚养费还能要吗？士嘉堡华人离婚律师何淼：常常还能</a>。欢迎致电647-930-6688咨询。',
    ],
  ...
  },
  {
    ...
    details: [
      'Child Support和Spousal Support是两个完全不同的概念，规则也完全不同。Child Support是孩子的权利，不是父母可以协议放弃的——即便双方都同意不支付，法院也不会批准。联邦《离婚法》第 11(1)(b) 条要求法院确认已有合理安排，否则可以中止发出离婚令。详见<a href="/blog/child-support-waiver-separation-agreement-ontario/">分居协议里可以不写子女抚养费吗</a>。',
  ...
  },
  {
    ...
    metaDescription:
      '法院可签发 Exclusive Possession Order 要求配偶搬离婚房。即使对方拒绝离开，仍可依法申请出售婚房并推进财产分割。何淼律师长期处理多伦多家庭法争议，普通话英语双语服务，帮助华人客户高效解决婚房占有与离婚财产问题。647-930-6688',
