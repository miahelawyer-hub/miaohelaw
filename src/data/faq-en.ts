...
[
  ...
  },
  {
    ...
    "details": [
      "A separation agreement is a domestic contract under Ontario Family Law Act. It can address: how net family property will be equalized (or how specific assets will be transferred), support obligations, and parenting arrangements including decision-making responsibility and parenting time.",
  ...
  },
  {
    ...
    "details": [
      "Under Ontario Family Law Act, pension plans are property subject to equalization. The pension value as of the date of separation is included in the pension holder net family property. The value accrued before the marriage can be deducted as a pre-marital exclusion, provided it can be properly documented.",
  ...
  },
  {
    ...
    "details": [
      "Ontario Family Law Act uses a system called equalization of net family property. The goal is to ensure that both spouses share equally in the wealth accumulated during the marriage — not to split every asset in half.",
  ...
  },
  {
    ...
    "details": [
      "Under Ontario Family Law Act, the value of property owned at the date of marriage is deductible from a spouse NFP. This means that pre-marital assets — cash, investments, real estate, business interests — are generally not subject to equalization.",
  ...
  },
  {
    ...
    "details": [
      "Under Ontario Family Law Act, both spouses have an equal right to possession of the matrimonial home during the marriage — regardless of who owns the property or whose name is on title. This right continues during the separation until it is dealt with by agreement or court order.",
