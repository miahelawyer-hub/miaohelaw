...
export const faqItemsEn: FaqItemEn[] = [
  {
    ...
    details: [
      'The Divorce Act sets out three grounds on which a court may grant a divorce. The first, and most commonly used, is separation for one year or more with no reasonable prospect of reconciliation. The second is adultery — one spouse has committed adultery and the other spouse has not condoned it. The third is physical or mental cruelty of such a kind that the petitioning spouse cannot reasonably be expected to continue cohabiting.',
  ...
  },
  {
    ...
    summary: "A spouse who refuses to participate cannot stop a divorce. After one year of separation, you can proceed with a divorce application even without the other party's cooperation. If they do not respond, the court can proceed in their absence and issue a Default Judgment.",
    answers: [
      "You can proceed with divorce even without your spouse's cooperation. Ontario courts do not require both parties to consent.",
  ...
  },
  {
    ...
    summary: "No. Ontario uses equalization of net family property, not a simple 50/50 split of every asset. The matrimonial home's full value at the date of separation is included in the calculation, but the outcome depends on the difference between each party's net family property — not a mechanical division of the home itself.",
    answers: [
    ...
    details: [
      ...
      'Both spouses have equal rights to possession of the matrimonial home during the separation, regardless of whose name is on title. Neither party can sell or mortgage the home without the other's consent.',
  ...
  },
  {
    ...
    summary: 'Child support is mandatory and formula-based under the Federal Child Support Guidelines: it depends on the paying parent's income and number of children. Spousal support is not automatic — it requires an entitlement analysis — and is calculated using the Spousal Support Advisory Guidelines, which provide a range rather than a fixed amount.',
    answers: [
      'Child support is mandatory and calculated under the federal Child Support Guidelines based on the paying parent's gross income and the number of children. The parties cannot agree to pay less than the table amount.',
    ...
    details: [
      'Child support in Ontario is governed by the Federal Child Support Guidelines. The table amount depends on: (1) the paying parent's gross annual income, (2) the number of children, and (3) the province of residence. This amount is mandatory — neither party can agree to waive or reduce it below the table amount.',
      ...
      'Once entitlement is established, the Spousal Support Advisory Guidelines provide a range for the amount and duration. Courts have significant discretion. Key factors include the length of the marriage, each spouse's income and earning capacity, and the economic consequences of the marriage breakdown.',
  ...
  },
  {
    ...
    details: [
      "Ontario's Family Law Act permits spouses to enter into a 'marriage contract' before or during marriage that governs how their property and support will be handled on separation. A marriage contract can exclude assets from equalization, modify support entitlements, and address specific property.",
  ...
  },
  {
    ...
    summary: "Ontario's equalization of net family property applies to worldwide assets, including Chinese real estate, bank accounts, and business interests. Tracing and enforcing judgments on overseas assets involves both legal systems. A lawyer licensed in both Ontario and China is essential for cross-border cases.",
    answers: [
      "Ontario's equalization principle applies to global assets. Chinese real estate, bank accounts, investments, and business interests held in China must all be disclosed and included in the net family property calculation.",
    ...
    details: [
      "Ontario's Family Law Act requires each spouse to disclose all of their property — worldwide — for the purposes of equalization. This includes real property in China, Chinese bank accounts, investments held through Chinese financial institutions, and interests in Chinese businesses.",
  ...
  },
  {
    ...
    details: [
      ...
      'The most effective approach is prevention. If you are concerned about abduction risk, an Ontario court can issue a Non-Removal Order prohibiting either parent from removing the child from Ontario (or Canada) without the other's consent or a court order. The child's passport can be seized and surrendered to the court. The child's name can be placed on the RCMP watch list at border crossings.',
  ...
  },
  {
    ...
    summary: 'An uncontested divorce with a fixed fee arrangement typically costs $2,000 to $5,000. Contested litigation is billed hourly — complex cases can cost $50,000 to $80,000+ per year in legal fees. Miao He's initial 30-minute consultation is $220 + HST.',
    answers: [
    ...
    details: [
      'Ontario divorce lawyers typically charge either a fixed fee for uncontested divorces or an hourly rate for contested matters. Fixed fee arrangements for a straightforward uncontested divorce (where a separation agreement is already in place) range from approximately $2,000 to $5,000 depending on the firm.',
      ...
      'Miao He's initial consultation is 30 minutes at $220 + HST, conducted in Mandarin or English. To book, call 647-930-6688.',
    ],
  ...
  },
  {
    ...
    details: [
      'A separation agreement is a domestic contract under Ontario's Family Law Act. It can address: how net family property will be equalized (or how specific assets will be transferred), support obligations, and parenting arrangements including decision-making responsibility and parenting time.',
  ...
  },
  {
    ...
    question: 'Is my spouse's pension divided in a divorce?',
    summary: 'Yes. Pension plans are included in the equalization of net family property calculation. The value accrued during the marriage is included in the pension holder's NFP. The method of division depends on the type of pension — defined benefit pensions require actuarial valuation.',
    answers: [
    ...
    details: [
      'Under Ontario's Family Law Act, pension plans are property subject to equalization. The pension's value as of the date of separation is included in the pension holder's net family property. The value accrued before the marriage can be deducted as a pre-marital exclusion, provided it can be properly documented.',
  ...
  },
  {
    ...
    summary: 'Equalization of net family property is Ontario's property division system. Each spouse calculates their Net Family Property (NFP): assets at date of separation minus debts minus pre-marital assets (with exceptions). The spouse with the higher NFP pays the other half the difference — called the equalization payment.',
    answers: [
    ...
    details: [
      'Ontario's Family Law Act uses a system called equalization of net family property. The goal is to ensure that both spouses share equally in the wealth accumulated during the marriage — not to split every asset in half.',
      'Each spouse calculates their Net Family Property (NFP) using this formula: (Value of all property at date of separation) minus (Debts and liabilities at date of separation) minus (Value of property owned at date of marriage, with exceptions). The result is each spouse's NFP.',
  ...
  },
  {
    ...
    details: [
      'Under Ontario's Family Law Act, the value of property owned at the date of marriage is deductible from a spouse's NFP. This means that pre-marital assets — cash, investments, real estate, business interests — are generally not subject to equalization.',
  ...
  },
  {
    ...
    details: [
      "Under Ontario's Family Law Act, both spouses have an equal right to possession of the matrimonial home during the marriage — regardless of who owns the property or whose name is on title. This right continues during the separation until it is dealt with by agreement or court order.",
      'Neither spouse can sell, mortgage, or encumber the matrimonial home without the other's written consent, even if only one spouse is on title. This protection exists to prevent one party from unilaterally disposing of the family home during a divorce.',
  ...
  },
  {
    ...
    summary: "The paramount consideration is always the best interests of the child. Relevant factors include each parent's relationship with the child, ability to meet the child's needs, each parent's willingness to support the child's relationship with the other parent, the child's own views, and any history of family violence.",
    answers: [
      "The best interests of the child is the only consideration. Every other factor is assessed through that lens.",
      "Key factors include: each parent's relationship with the child, stability of each home environment, the child's own views and preferences, willingness to facilitate the child's relationship with the other parent, and any history of violence or abuse.",
    ],
    details: [
      'Under both the Divorce Act and Ontario's Children's Law Reform Act, the paramount consideration in all parenting decisions is the best interests of the child. Courts do not apply a presumption in favour of either parent.',
      'Specific factors courts consider include: the nature and strength of the child's relationship with each parent; each parent's ability to provide for the child's physical, emotional, and developmental needs; the child's own views and preferences, considered proportionally to their age and maturity; each parent's willingness to support the child's relationship with the other parent; the stability and continuity of the child's current environment; and any history of family violence, including the impact on the child.',
      'Courts pay particular attention to the willingness of each parent to facilitate the child's relationship with the other parent. A parent who attempts to alienate the child from the other parent — through negative comments, withholding information, or frustrating parenting time — risks losing credibility with the court.',
      'The child's own voice is increasingly important. While courts do not allow children to simply choose which parent they live with, older children's expressed preferences carry significant weight, particularly if the preference is clearly articulated and consistent.',
  ...
  },
  {
    ...
    details: [
      ...
      'The consultation can take place in person at the H. LAW FIRM 恒. 律师事务所 office at 208-7050 Woodbine Avenue, Markham, Ontario, or by video conference for clients who prefer to meet remotely.',
