...
[
  ...
  {
    slug: "how-to-prepare-case-conference-ontario",
    question: "What do I need to prepare for a case conference in Ontario family court?",
    featured: true,
    pairedFaqPath: "/faq/case-conference-xuyao-zhunbei-shenme/",
    metaTitle: "What Do I Need to Prepare for a Case Conference?",
    metaDescription:
      "A Form 17A brief and a Form 17F confirmation are mandatory, plus financial statements if property or support is in issue. Deadlines, page limits and what happens if you miss them.",
    summary:
      "Two documents are mandatory: <strong>Form 17A</strong> (Case Conference Brief) and <strong>Form 17F</strong> (Confirmation of Conference). If property division, child support or spousal support is in issue, you also need financial statements. The two forms have different deadlines, and missing the Form 17F deadline will normally get your conference cancelled.",
    answers: [
      "The core filings are <strong>Form 17A</strong> and <strong>Form 17F</strong>; if property or support is in issue, also prepare Form 13/13.1 (Financial Statement) and Form 13A (Certificate of Financial Disclosure).",
      "Form 17A is usually capped at <strong>eight pages</strong> (some courthouses such as Barrie allow twelve). The party who secured the date serves and files <strong>six days</strong> before; the other party <strong>four days</strong> before (Rule 17(13.1)).",
      "Form 17F must be <strong>served on the other party before it is given to the clerk</strong>, generally no later than 2:00 p.m. three business days before the conference. Missing it normally takes the date off the list.",
